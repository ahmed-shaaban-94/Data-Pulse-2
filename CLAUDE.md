...
**`008-sales-transaction-capture` is CLOSED on `main`** (2026-05-31, 16/16 slices merged, PRs #420–#435). No 008 slice is in active development — confirm current state via GitHub (open PRs, recent commits) before acting. Recent shipped work and documented partials:
