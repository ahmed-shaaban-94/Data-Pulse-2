...
**`009-inventory-stock-ledger` is IN PROGRESS on `main`** (7/15 slices merged, PRs #438–#444). `008-sales-transaction-capture` is **CLOSED** (2026-05-31, 16/16 slices, PRs #420–#435). Confirm current state via GitHub (open PRs, recent commits) before acting. Recent shipped work and documented partials:
