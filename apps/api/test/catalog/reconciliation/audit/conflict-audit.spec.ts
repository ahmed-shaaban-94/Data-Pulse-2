...
/**
 * Build a mock PoolClient that returns `lockRow` from the FOR UPDATE select
 * and runs `onInsert` for the first non-control query after the lock (used to
 * inject a fault). All other queries return empty results.
 */
