...
beforeAll(async () => {
  ...
  const moduleRef = await Test.createTestingModule({
    ...
    providers: [
      ...
      // idempotency-key replay semantics — admin isolates the replay behavior
      // from RLS, not the data-access path. RLS coverage for the data path is
      // asserted by capture-happy-path.spec.ts. Pattern:
