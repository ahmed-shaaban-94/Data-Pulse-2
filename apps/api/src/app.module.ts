...
import { PairingModule } from "./pos-terminal-pairing/pairing.module";
...
import { SaleSyncOpsModule } from "./catalog/sale-sync-ops/sale-sync-ops.module";
