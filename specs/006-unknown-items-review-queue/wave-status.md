...
| T023 close-by-execution | Active feature section of CLAUDE.md does not reference 006 follow-up work; 006 appears only in Specs summary (added by T002 in PR #380). Slice's expected state holds; no CLAUDE.md edit required. Separately-flagged doc-debt (the "004 active" framing is stale — 004 substantially closed, 005 shipped Waves 1+2) is out of T023's scope and recorded as a future CLAUDE.md-refresh slice candidate. | PR #382 (this PR) (2026-05-28) |
