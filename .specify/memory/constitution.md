...
Templates requiring updates:
  ...
  ✅ created  .specify/templates/constitution-template.md (mirror of this file for future scaffolds)
  ✅ created  .gitignore (excludes /reference/ legacy clone path per Principle I)
Follow-up TODOs:
  - TODO(RATIFICATION_DATE): set to 2026-05-01 by initial author; revise if formal adoption date differs.
  - Run /speckit-plan, /speckit-specify, /speckit-tasks once features are scoped.
-->
